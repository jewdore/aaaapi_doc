...
| `vibe_transfer[].information_extracted` | float | ❌ No | `1.0` | Information extraction level (`0.01` - `1.0`) |
| `vibe_transfer[].strength` | float | ❌ No | `0.6` | Style transfer strength (`0.01` - `1.0`) |
...
| `character_prompts[].center.x` | float | ❌ No | `0.5` | X coordinate (`0.1` - `0.9`), `0.5` = horizontal center |
| `character_prompts[].center.y` | float | ❌ No | `0.5` | Y coordinate (`0.1` - `0.9`), `0.5` = vertical center |
...
| `director_reference_information_extracted` | array | ❌ No | Array of information extraction levels (`0.0` - `1.0`) |
| `director_reference_strength_values` | array | ❌ No | Array of primary strength values (`0.0` - `1.0`) |
| `director_reference_secondary_strength_values` | array | ❌ No | Array of secondary strength values (`0.0` - `1.0`), typically `0` |
