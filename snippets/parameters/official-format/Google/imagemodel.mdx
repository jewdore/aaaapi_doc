...
| >`generation_config.response_modalities` | array | ❌ No | - | `TEXT`<br />`IMAGE` | The modalities of the response. If set for models that don't support these configuration options, the system will return an error. |
  ...
  "contents": [
    {
      ...
      "parts": [
        ...
        },
        {
          "file_data": {
            "mime_type": "image/png",
            "file_uri": "https://example.com/image2.png"
          }
        },
        {
...
| >`image_config.image_size` | string | ❌ No | - | `1K`<br />`2K`<br />`4K` | Approximate size of the generated image. If not specified, the model will use the default value of 1K. only Gemini 3 Pro Image Preview,|
