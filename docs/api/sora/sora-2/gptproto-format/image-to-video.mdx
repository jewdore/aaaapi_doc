...
| `image` | string | ❌ No | `https://filesystem.site/cdn/202xxx/xxxx.png` | Image parameter |
...
url = "gptproto/api/v3/openai/sora-2/image-to-video"
headers = {
...
const url = "gptproto/api/v3/openai/sora-2/image-to-video";
const headers = {
  "Authorization": "YOUR_API_KEY",
  "Content-Type": "application/json"
};
