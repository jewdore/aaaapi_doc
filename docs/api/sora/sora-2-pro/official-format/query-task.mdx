...
```bash cURL
curl -X GET "https://gptproto.com/v1/videos/video_69046bc7aba08190be36e34d2a0b38d604b0ac9360275679" \
  -H "Authorization: sk-***********" \
...
url = "https://gptproto.com/v1/videos/video_69046bc7aba08190be36e34d2a0b38d604b0ac9360275679"
headers = {
    "Authorization": "sk-***********",
...
const url = "https://gptproto.com/v1/videos/video_69046bc7aba08190be36e34d2a0b38d604b0ac9360275679";
const headers = {
  "Authorization": "sk-***********",
  "Content-Type": "application/json"
};
