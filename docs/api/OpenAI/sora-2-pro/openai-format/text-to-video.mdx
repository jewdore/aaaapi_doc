  ...
  "messages": [
    {
      ...
      "content": [
        ...
        },
        {
          "type": "image_url",
          "image_url": {
            "url": "https://oss.gptproto.com/ai-draw/material/land-part1-default.png"
          }
        }
      ]
    }
...
| `file_url` | object | ✅ Yes | - |  * type:file_url,The URL of the file to use for the generation. Supports: PDF, DOCX, XLSX, TXT, CSV, JSON, XML, HTML. Maximum file size: 20MB. |
