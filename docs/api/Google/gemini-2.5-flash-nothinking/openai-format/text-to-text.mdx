...
Gemini's openai format for the text to text API.
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `gemini-2.5-flash-nothinking` | The model to use for the request. `gemini-2.5-flash-nothinking` |
