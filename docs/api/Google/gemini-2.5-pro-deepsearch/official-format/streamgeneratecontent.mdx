---
title: 'gemini-25-pro-deepsearch (streamgeneratecontent)'
sidebarTitle: 'streamGenerateContent'
api: 'POST /v1beta/models/gemini-2.5-pro-deepsearch:streamGenerateContent'
description: 'streamGenerateContent'
mode: 'wide'
---

Gemini's official format for the streamgeneratecontent API.
...
```bash cURL
curl -X POST "https://gptproto.com/v1beta/models/gemini-2.5-pro-deepsearch:streamGenerateContent" \
...
url = "https://gptproto.com/v1beta/models/gemini-2.5-pro-deepsearch:streamGenerateContent"
headers = {
...
const url = "https://gptproto.com/v1beta/models/gemini-2.5-pro-deepsearch:streamGenerateContent";
const headers = {
  "Authorization": "YOUR_API_KEY",
  "Content-Type": "application/json"
};
