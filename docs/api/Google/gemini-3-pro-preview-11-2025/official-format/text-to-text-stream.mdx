---
title: 'gemini-3-pro-preview-11-2025 (text to text stream)'
sidebarTitle: 'Text to Text (Stream)'
...
```bash cURL
curl --location 'https://gptproto.com/v1beta/models/gemini-3-pro-preview-11-2025:streamGenerateContent' \
...
url = "https://gptproto.com/v1beta/models/gemini-3-pro-preview-11-2025:streamGenerateContent"
headers = {
    "Authorization": "sk-***********",
...
const url = "https://gptproto.com/v1beta/models/gemini-3-pro-preview-11-2025:streamGenerateContent";
const headers = {
  "Authorization": "sk-***********",
  "Content-Type": "application/json"
};
