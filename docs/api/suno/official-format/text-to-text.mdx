...
[Suno AI](https://suno.com) provides a powerful lyrics generation capability that creates high-quality song lyrics from text descriptions. Using Suno's API, you can generate original lyrics for any musical style, theme, or mood by simply describing what you want in natural language.

Related Guides: [Suno Official Documentation](https://suno.com/docs) | [Lyrics Generation Guide](https://suno.com/guides/lyrics-generation)

This endpoint allows you to submit lyrics generation tasks using simple text prompts. The generation is processed asynchronously - you'll receive a task ID immediately, which you can use to check the status and retrieve the generated lyrics once complete.
...
<ParamField body="prompt" type="string" required default="Write lyrics about a sunrise over the ocean with a hopeful tone">
...
<Expandable title="Response Fields">
  <ResponseField name="code" type="string">
    Status code indicating success or error (`"success"` or `"error"`)
  </ResponseField>

  <ResponseField name="data" type="string">
    Task ID for tracking the lyrics generation progress. Use this ID with the [Query Task Status](/api/suno/official-format/query-task) endpoint to check completion and retrieve the generated lyrics.
  </ResponseField>
...
3. **Use with Music Generation** - Combine the generated lyrics with the [Text to Audio](/api/suno/official-format/text-to-audio) endpoint to create complete songs
...
- [Text to Audio](/api/suno/official-format/text-to-audio) - Generate music from text or lyrics
- [Query Task Status](/api/suno/official-format/query-task) - Check generation progress and retrieve results
