...
[Suno AI](https://suno.com) is a powerful music generation platform that creates high-quality music from text descriptions. Using Suno's API, you can create original songs, background music, instrumentals, and custom audio compositions by simply describing what you want in natural language.

Related Guides: [Suno Official Documentation](https://suno.com/docs) | [Music Generation Guide](https://suno.com/guides/music-generation)

This endpoint allows you to submit music generation tasks using simple text prompts. The generation is processed asynchronously - you'll receive a task ID immediately, which you can use to check the status and retrieve the generated audio once complete.
...
<ParamField body="prompt" type="string" default="Compose a tense pre-battle anthem">
...
<ParamField body="gpt_description_prompt" type="string" default="Ethereal female vocals blending with cinematic drums">
...
<ParamField body="mv" type="string" default="chirp-v3-0">
...
<ParamField body="tags" type="string" default="cinematic,epic,ambient">
...
<ParamField body="title" type="string" default="Before the Charge">
...
<ParamField body="continue_at" type="number" default="8">
...
<ParamField body="continue_clip_id" type="string" default="clip-123456">
...
<ParamField body="task_id" type="string" default="task-001">
...
<Expandable title="Response Fields">
  ...
  <ResponseField name="data" type="string">
    Task ID for tracking the music generation progress. Use this ID with the [Query Task Status](/api/suno/official-format/query-task) endpoint to check completion and retrieve the audio URL.
  </ResponseField>
