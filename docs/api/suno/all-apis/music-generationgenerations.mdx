...
description: '生成音乐接口, 可以直接生成也可续写音乐如果是续写用户上传的音乐则需要在 mv 字段后面加个`-upload` 如 `chirp-v3-5-upload`'
---

## Overview

生成音乐接口, 可以直接生成也可续写音乐如果是续写用户上传的音乐则需要在 mv 字段后面加个`-upload` 如 `chirp-v3-5-upload`
