---
title: 'speech-25-hd-preview-voice-clone (get task)'
...
```bash cURL
curl -X GET "https://gptproto.com/api/v3/predictions/3cafe8541391455fba76ce18829ef4c9/result" \
  -H "Authorization: sk-***********" \
...
const url = "https://gptproto.com/api/v3/predictions/3cafe8541391455fba76ce18829ef4c9/result";
const headers = {
  "Authorization": "sk-***********",
  "Content-Type": "application/json"
};
