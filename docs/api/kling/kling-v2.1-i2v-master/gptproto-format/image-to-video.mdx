---
title: 'kling-v2.1-i2v-master (image to video)'
...
|-----------|------|----------|---------|-------------|
| `prompt` | string | ✅ Yes | `The character in the picture walks to the anime garden to find a comb placed on the ground, without changing the proportion of the character&apos;&apos;&apos;s face` | Prompt parameter |
| `image` | string | ❌ No | `https://oss.heyoos.com/ai-draw/user/-ead3cec3-de6b-4ed5-b38c-4d8707731686.png` | Image parameter |
| `guidance_scale` | number | ❌ No | `0.5` | Guidance Scale parameter |
