...
```bash cURL
curl -X POST "gptproto/api/v3/kwaivgi/kling-v2.5-turbo-pro/image-to-video" \
...
url = "gptproto/api/v3/kwaivgi/kling-v2.5-turbo-pro/image-to-video"
headers = {
...
const url = "gptproto/api/v3/kwaivgi/kling-v2.5-turbo-pro/image-to-video";
const headers = {
  "Authorization": "Bearer YOUR_API_KEY",
  "Content-Type": "application/json"
};
