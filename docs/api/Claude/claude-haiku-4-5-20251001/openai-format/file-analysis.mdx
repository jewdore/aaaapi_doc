...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `claude-haiku-4-5-20251001` | The model to use for file analysis. Must be `claude-haiku-4-5-20251001` or another Claude model with file analysis capabilities. |
