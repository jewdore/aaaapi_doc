...
<ParamField body="model" type="string" required default="claude-opus-4-1-20250805">
  The model to use for file analysis. Must be `claude-opus-4-1-20250805` or another Claude model with file analysis capabilities.
</ParamField>
