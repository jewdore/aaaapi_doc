...
<ParamField body="model" type="string" required default="claude-3-5-haiku-20241022">
  The model to use for file analysis. Must be `claude-3-5-haiku-20241022` or another Claude model with file analysis capabilities.
</ParamField>
