...
<ParamField body="model" type="string" required default="claude-sonnet-4-5-20250929-thinking">
  The model to use for file analysis. Must be `claude-sonnet-4-5-20250929-thinking` or another Claude model with file analysis capabilities.
</ParamField>
