---
title: 'PDF analysis example:two'
api: 'POST /v1/messages'
description: 'PDF analysis example:two'
---

## Overview

This endpoint provides pdf analysis example:two functionality using Anthropic native format.
