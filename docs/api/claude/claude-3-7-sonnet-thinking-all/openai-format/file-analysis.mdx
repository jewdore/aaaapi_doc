...
<ParamField body="model" type="string" required default="claude-3-7-sonnet-thinking-all">
  The model to use for file analysis. Must be `claude-3-7-sonnet-thinking-all` or another Claude model with file analysis capabilities.
</ParamField>
