...
<ParamField body="model" type="string" required default="claude-sonnet-4-5-20250929">
  The model to use for file analysis. Must be `claude-sonnet-4-5-20250929` or another Claude model with file analysis capabilities.
</ParamField>
