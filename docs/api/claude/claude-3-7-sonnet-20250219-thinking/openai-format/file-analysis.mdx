...
<ParamField body="model" type="string" required default="claude-3-7-sonnet-20250219-thinking">
  The model to use for file analysis. Must be `claude-3-7-sonnet-20250219-thinking` or another Claude model with file analysis capabilities.
</ParamField>
