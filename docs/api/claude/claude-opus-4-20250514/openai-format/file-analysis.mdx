...
<ParamField body="model" type="string" required default="claude-opus-4-20250514">
  The model to use for file analysis. Must be `claude-opus-4-20250514` or another Claude model with file analysis capabilities.
</ParamField>
