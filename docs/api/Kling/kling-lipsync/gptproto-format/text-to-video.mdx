...
- **Query Results**: Use the task ID returned in the response to query the generation status via the [Query Task](docs/api/Kling/kling-lipsync/gptproto-format/query-task) endpoint
