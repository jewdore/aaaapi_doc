---
title: 'chat text mode(Support for grok4)'
api: 'POST /v1/chat/completions'
description: 'chat text mode(Support for grok4)'
---

## Overview

This endpoint provides chat text mode(support for grok4) functionality.
