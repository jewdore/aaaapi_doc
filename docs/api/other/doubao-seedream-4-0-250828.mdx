...
This endpoint provides doubao-seedream-4-0-250828 functionality.
...
<ParamField body="prompt_enhancement" type="boolean" >
...
<ParamField body="reflection_enabled" type="boolean" >
