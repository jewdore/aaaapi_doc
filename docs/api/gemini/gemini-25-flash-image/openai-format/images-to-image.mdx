...
url = "https://gptproto/v1/chat/completions"
headers = {
...
const url = "https://gptproto/v1/chat/completions";
const headers = {
  "Authorization": "Bearer YOUR_API_KEY",
  "Content-Type": "application/json"
};
...
<ParamField body="messages" default='[{ "role": "user", "content": "Two people standing together ", "experimental_attachments": [{ "contentType": "image/png", "url": "https://mgszhhytxjyitifbalro.supabase.co/storage/v1/object/public/chat-attachments/uploads/guakmauqtr.png"}, { "contentType": "image/jpeg", "url": "https://mgszhhytxjyitifbalro.supabase.co/storage/v1/object/public/chat-attachments/uploads/3ox9ikxbcxc.jpeg"}]}]' type="array" required>
