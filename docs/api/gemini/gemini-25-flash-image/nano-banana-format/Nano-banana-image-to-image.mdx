...
api: "POST /api/v3/google/nano-banana/image-to-image"
description: "Nano-banana-image-to-image"
---
...
<ParamField body="enable_sync_mode" default="false" type="boolean">
  1If set to true, the function will wait for the result to be generated and uploaded before returning the response. It allows you to get the result directly in the response. This property is only available through the API.
</ParamField>
...
```bash cURL
curl --location 'https://gptproto.com/api/v3/google/nano-banana/text-to-image' \
--header 'Authorization: sk-xxxx' \
