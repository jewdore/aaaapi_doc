  ...
  <Expandable title="properties">
    <ParamField body="parts" type="array" required>
      <Expandable title="properties" defaultOpen="true">
        <ParamField body="text" default="Create a picture of a nano banana dish in a fancy restaurant with a Gemini theme" type="string" required>
...
<ParamField body="generationConfig" type="object">
  <Expandable title="properties">
    <ParamField body="responseModalities" default='["Text", "Image"]' type="array">
    ...
    <ParamField body="imageConfig" type="object">
      <Expandable title="properties" defaultOpen="true">
        <ParamField body="aspectRatio" default="1:1" type="string">
