...
<ParamField path="model" type="string" required default="gemini-2.0-flash">
  The model to use for content generation. Available models: `gemini-2.0-flash`, etc.
</ParamField>
...
```bash cURL
curl --location 'https://gptproto.com/v1beta/models/gemini-2.0-flash:streamGenerateContent' \
