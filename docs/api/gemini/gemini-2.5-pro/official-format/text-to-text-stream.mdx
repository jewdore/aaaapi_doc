...
<ParamField path="model" type="string" required default="gemini-2.5-pro">
  The model to use for content generation. Available models: `gemini-2.5-pro`, etc.
</ParamField>
...
url = "https://gptproto.com/v1beta/models/gemini-2.5-pro:streamGenerateContent"
headers = {
    "Authorization": "sk-***********",
...
const url = "https://gptproto.com/v1beta/models/gemini-2.5-pro:streamGenerateContent";
const headers = {
  "Authorization": "sk-***********",
  "Content-Type": "application/json"
};
