...
<ParamField body="displayName" type="string" required default="file_test.pdf">
  displayName parameter
</ParamField>

<ParamField body="file" type="file" required default="cmMtdXBsb2FkLTE3NTc1OTAwMTQ1MjgtMw==/Alibaba_Java_Development_Manual_v1.3.0.pdf">
  file parameter
</ParamField>
