...
<ParamField path="model" type="string" required default="gemini-3-pro-preview">
  The model to use for content generation. Available models: `gemini-3-pro-preview`, etc.
</ParamField>
...
url = "https://gptproto.com/v1beta/models/gemini-3-pro-preview:streamGenerateContent"
headers = {
    "Authorization": "sk-***********",
...
const url = "https://gptproto.com/v1beta/models/gemini-3-pro-preview:streamGenerateContent";
const headers = {
  "Authorization": "sk-***********",
  "Content-Type": "application/json"
};
