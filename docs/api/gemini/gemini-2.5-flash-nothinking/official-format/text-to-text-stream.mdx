...
```bash cURL
curl --location 'https://gptproto.com/v1beta/models/gemini-2.5-flash-nothinking:streamGenerateContent' \
...
url = "https://gptproto.com/v1beta/models/gemini-2.5-flash-nothinking:streamGenerateContent"
headers = {
    "Authorization": "sk-***********",
...
const url = "https://gptproto.com/v1beta/models/gemini-2.5-flash-nothinking:streamGenerateContent";
const headers = {
  "Authorization": "sk-***********",
  "Content-Type": "application/json"
};
