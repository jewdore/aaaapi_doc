...
description: 'Upload files to Google Generative AI API (North America region)'
---
...
```bash cURL
curl --location 'https://api-na.gptproto.com/v1beta/files' \
...
url = "https://api-na.gptproto.com/v1beta/files"
headers = {
...
const url = "https://api-na.gptproto.com/v1beta/files";
