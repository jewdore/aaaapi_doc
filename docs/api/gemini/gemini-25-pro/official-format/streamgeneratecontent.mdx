---
title: 'gemini-25-pro (streamgeneratecontent)'
sidebarTitle: 'streamGenerateContent'
api: 'POST /v1beta/models/gemini-2.5-pro:streamGenerateContent'
...
```bash cURL
curl -X POST "https://gptproto.com/v1beta/models/gemini-2.5-pro:streamGenerateContent" \
