...
Gemini's chat format for the image to image API.
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `gemini-2.5-flash-image-preview-hd` | The model to use for the request. `gemini-2.5-flash-image-preview-hd` |
