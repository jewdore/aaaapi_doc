---
title: 'gemini-series (chat image mode)'
sidebarTitle: 'chat image mode'
api: 'POST /v1/chat/completions'
description: 'chat image mode'
mode: 'wide'
---

Gemini's chat image mode.mdx for the chat image mode API.
...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `gemini-2.0-flash-exp-image-generation` | The model to use for the request. `gemini-2.0-flash-exp-image-generation` |
