...
<ParamField body="messages" type="array" required example={[
    {
      role: "user",
      content: [
        {
          type: "text",
          text: "The positive prompt for the generation."
        }
      ]
    }
  ]}>
  ...
  <Expandable title="properties">
    ...
    <ParamField body="role" type="string" required example="user">
    ...
    <ParamField body="content" type="array" required>
      <Expandable title="items">
        ...
        <ParamField body="type" type="string" required example="text">
          text
        </ParamField>

        <ParamField body="text" type="string" required example="The positive prompt for the generation.">
