                            ...
                            <Expandable title="properties">
                                  <ParamField body="type" type="string" required>
                                    ...
                                    <ParamField body="image_url" type="object" required>
                                     ...
                                     <ParamField body="file_url" type="object" required>
                                      <ParamField body="url" type="string" required>
                                        * type:file_url,The URL of the file to use for the generation. Supports: PDF, DOCX, XLSX, TXT, CSV, JSON, XML, HTML. Maximum file size: 20MB.
                                      </ParamField>
                                    </ParamField>
                            </Expandable>
