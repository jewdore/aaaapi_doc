...
```bash cURL
curl -X GET "https://gptproto.com/v1/videos/your_video_id" \
  -H "Authorization: sk-***********" \
...
url = "https://gptproto.com/v1/videos/your_video_id"
headers = {
    "Authorization": "sk-***********",
...
const url = "https://gptproto.com/v1/videos/your_video_id";
const headers = {
  "Authorization": "sk-***********",
  "Content-Type": "application/json"
};
