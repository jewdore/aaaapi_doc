...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `sora-2-pro` | The video generation model to use. Defaults to sora-2-pro. |
| `prompt` | string | ✅ Yes | - | Text prompt that describes the video to generate. |
| `input_reference` | string | ✅ Yes | - | Image reference that guides generation. Image size 720x1280 or 1280x720. |
