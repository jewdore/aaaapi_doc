...
data = {
    "model": "sora-2-pro",
    "prompt": "The character walks slowly and then sits on the ground",
    "size": "720x1280",
    "seconds": "4"
}
...
formData.append("prompt", "The character walks slowly and then sits on the ground");
...
func main() {
    ...
    writer.WriteField("prompt", "The character walks slowly and then sits on the ground")
