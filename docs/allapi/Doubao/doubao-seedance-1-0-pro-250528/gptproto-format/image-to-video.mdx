...
api: "POST /api/v3/bytedance/doubao-doubao-seedance-1-0-pro-250528/image-to-video"
description: "Generate videos from input images using Doubao Seedance model with customizable duration, aspect ratio, and audio generation"
mode: 'wide'
---
...
```bash cURL
curl --location --request POST 'https://gptproto.com/api/v3/bytedance/doubao-doubao-seedance-1-0-pro-250528/image-to-video' \
...
url = "https://gptproto.com/api/v3/bytedance/doubao-doubao-seedance-1-0-pro-250528/image-to-video"
...
const url = 'https://gptproto.com/api/v3/bytedance/doubao-doubao-seedance-1-0-pro-250528/image-to-video';
