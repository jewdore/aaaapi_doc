...
description: "Edit and modify images using OpenAI's GPT Image model with customizable quality and size options"
mode: 'wide'
---
...
```bash cURL
curl --location --request POST "https://gptproto.com/api/v3/openai/gpt-image-1/image-edit" \
