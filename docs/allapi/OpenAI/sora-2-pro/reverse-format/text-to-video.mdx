...
api: 'POST https://gptproto.com/v3/openai/reverse/sora-2-pro/text-to-video'
description: ''
mode: 'wide'
---
...
<CodeGroup>
```bash cURL
curl --location 'https://gptproto.com/v3/openai/reverse/sora-2-pro/text-to-video' \
...
let config = {
  ...
  url: 'https://gptproto.com/v3/openai/reverse/sora-2-pro/text-to-video',
  headers: { 
