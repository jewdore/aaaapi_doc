...
api: "POST /api/v3/openai/gpt-image-1-mini/text-to-image"
...
```bash cURL
curl --location --request POST "https://gptproto.com/api/v3/openai/gpt-image-1-mini/text-to-image" \
...
const url = 'https://gptproto.com/api/v3/openai/gpt-image-1-mini/text-to-image';
