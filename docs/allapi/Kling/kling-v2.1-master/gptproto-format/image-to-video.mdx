...
api: 'POST http://gptproto.com/api/v3/kwaivgi/kling-v2.1-master/image-to-video'
description: ''
mode: 'wide'
---
...
<CodeGroup>
```bash cURL
curl --location 'http://gptproto.com/api/v3/kwaivgi/kling-v2.1-master/image-to-video' \
...
let config = {
  ...
  url: 'http://gptproto.com/api/v3/kwaivgi/kling-v2.1-master/image-to-video',
  headers: { 
