...
api: 'POST https://gptproto.com/api/v3/vidu/viduq2-turbo/start-end-framed'
description: ''
mode: 'wide'
---
...
<CodeGroup>
```bash cURL
curl --location 'https://gptproto.com/api/v3/vidu/viduq2-turbo/start-end-framed' \
...
let config = {
  ...
  url: 'https://gptproto.com/api/v3/vidu/viduq2-turbo/start-end-framed',
  headers: { 
