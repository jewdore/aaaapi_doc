...
api: "POST /api/v3/google/gemini-2.5-flash-image-preview-hd/text-to-image"
description: "Generate high-definition images from text prompts using Gemini Flash Image Preview HD model"
mode: 'wide'
---
...
url = "https://gptproto.com/api/v3/google/gemini-2.5-flash-image-preview-hd/text-to-image"
...
const url = 'https://gptproto.com/api/v3/google/gemini-2.5-flash-image-preview-hd/text-to-image';
