---
title: 'gemini-2.5-flash-image-preview-hd (Image Edit (Chat))'
sidebarTitle: 'Image Edit (Chat)'
api: "POST /v1/chat/completions"
description: "Edit images through conversational interface using Gemini Flash Image Preview HD model"
mode: 'wide'
---
