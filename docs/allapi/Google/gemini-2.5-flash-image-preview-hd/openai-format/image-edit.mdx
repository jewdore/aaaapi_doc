...
data.append('model', 'gemini-2.5-flash-image-preview-hd');
...
payload = {'model': 'gemini-2.5-flash-image-preview-hd',
...
func main() {
  ...
  _ = writer.WriteField("model", "gemini-2.5-flash-image-preview-hd")
