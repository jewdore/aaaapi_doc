...
description: "Edit and modify images using Gemini Flash Image HD model with custom prompts"
mode: 'wide'
---
...
form.append('model', 'gemini-2.5-flash-image-hd');
...
func main() {
    ...
    writer.WriteField("model", "gemini-2.5-flash-image-hd")
