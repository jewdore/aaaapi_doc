...
|-----------|------|----------|---------|-------------|
| `model` | string | ✅ Yes | `gemini-3-pro-image-preview` | The model to use for the request |
| `prompt` | string | ✅ Yes | - | Prompt can add image url Supported MIME types: `image/png`, `image/jpeg`, `image/webp` |
