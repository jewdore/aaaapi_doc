...
api: 'POST /api/v3/google/gemini-3-pro-image-preview/image-edit'
...
const url = "https://gptproto.com/api/v3/google/gemini-3-pro-image-preview/image-edit";
const headers = {
  "Authorization": "Bearer ${GPTPROTO_API_KEY}",
  "Content-Type": "application/json"
};
...
|-----------|------|----------|---------|-------------|
| `prompt` | string | ✅ Yes | - | A text description of the desired image edit. The prompt should be detailed and describe the changes you want to make to the input images. |
| `images` | array | ✅ Yes | - | An array of image URLs that you want to edit or combine. Supported MIME types: `image/png`, `image/jpeg`, `image/webp` |
| `output_format` | string | ❌ No | `png` | The format in which the generated images should be returned. Must be one of `url` or `b64_json`. |
